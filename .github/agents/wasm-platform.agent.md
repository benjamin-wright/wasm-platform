...
tools: [read, edit, search, todo, execute/runInTerminal, context7/*, tilt/*]
---
...
3. Read the `README.md` for the component you're changing — understand its observable behaviour.
4. For design-level changes, also read `docs/architecture.md`.
5. If the task contradicts existing plans, standards, or a README spec, **cite the conflict and ask** — do not resolve it silently.
...
- **Verification:** run `tilt ci` after every phase. A phase is not complete until it exits 0.
